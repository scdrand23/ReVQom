...
from revqom.models.fuse_modules.att_fuse import ScaledDotProductAttention
from revqom.models.sub_modules.torch_transformation_utils import \
    warp_affine_simple
...
class DiscoFusion(nn.Module):
    def __init__(self, feature_dims):
        ...
        from revqom.models.fuse_modules.disco_fuse import PixelWeightLayer
...
class V2VNetFusion(nn.Module):
    def __init__(self, args):
        ...
        from revqom.models.sub_modules.convgru import ConvGRU
...
class V2XViTFusion(nn.Module):
    def __init__(self, args):
        ...
        from revqom.models.fuse_modules.v2xvit_basic import V2XTransformer
