...
import revqom.utils.common_utils as common_utils
from revqom.utils.transformation_utils import x1_to_x2, x_to_world
from revqom.utils.constants import GT_RANGE 
import copy
...
def project_world_objects(object_dict,
    ...
    for object_id, object_content in object_dict.items():
        ...
        obj_type = object_content.get('obj_type', np.array([0]))
